        ...
        <>
            <div className={style.head}>
                <div className={style.league}>
                    {
                        ...
                        <div className={style.country}>
                            <img src={`https://www.matchtracker.live/v2/images/flags/${data.league.cc}.svg`} alt=""/>
                        </div>
                    }
                    <p>{data.league.name}</p>
                    {
                        ...
                        <>
                            ...
                            <div className={style.wrapper}>
                                ...
                                <p>{t('interface.round')} {data.extra.round}</p>
                            </div>
                        </>
                    }
                </div>
                {
                    ...
                    <div className={style.wrapper}>
                        ...
                        <p>{data.extra.stadium_data.name}</p>
                    </div>
                }
            </div>
            <div className={style.body}>
                <div className={style.cell}>
                    {
                        (data.home.image_id || data.home.cc) &&
                        <div className={style.logo}>
                            {
                                data.home.image_id
                                    ...
                                    :
                                    <img
                                        src={`https://assets.betsapi.com/v2/images/flags/${data.home.cc}.svg`}
                                        alt={data.home.name}
                                    />
                            }
                        </div>
                    }
                    <div className={style.nickname}>{data.home.name}</div>
                    {
                        data.extra &&
                        data.extra.home_manager &&
                        <div className={style.manager}>
                            {
                                data.extra.home_manager.cc &&
                                <div className={style.country}>
                                    <img src={`https://assets.betsapi.com/v2/images/flags/${data.extra.home_manager.cc}.svg`} alt=""/>
                                </div>
                            }
                            <p>{data.extra.home_manager.name}</p>
                        </div>
                    }
                </div>
                <div className={style.cell}>
                    {
                        data.time_status === '3'
                            ...
                            <div className={style.timer}>
                                <span>{convertTime(data.time)}</span>
                            </div>
                    }
                    {
                        data.timer &&
                        <div className={style.timer}>
                            <span>{convertTimer(data.timer.tm)}</span>
                            <span>:</span>
                            <span>{convertTimer(data.timer.ts)}</span>
                        </div>
                    }
                    {
                        data.ss &&
                        <div className={style.score}>
                            <div>{data.ss.split('-')[0]}</div>
                            <div>-</div>
                            <div>{data.ss.split('-')[1]}</div>
                        </div>
                    }
                    {
                        data.extra &&
                        ...
                        <div className={style.manager}>
                            <>
                                <div className={style.country}>
                                    <img src={`https://assets.betsapi.com/v2/images/flags/${data.extra.referee.cc}.svg`} alt=""/>
                                </div>
                                <p>{data.extra.referee.name}</p>
                            </>
                        </div>
                    }
                </div>
                <div className={style.cell}>
                    {
                        (data.away.image_id || data.away.cc) &&
                        <div className={style.logo}>
                            {
                                data.away.image_id
                                    ?
                                    ...
                                    :
                                    <img
                                        src={`https://assets.betsapi.com/v2/images/flags/${data.away.cc}.svg`}
                                        alt={data.home.name}
                                    />
                            }
                        </div>
                    }
                    <div className={style.nickname}>{data.away.name}</div>
                    {
                        data.extra &&
                        data.extra.away_manager &&
                        <div className={style.manager}>
                            {
                                data.extra.away_manager.cc &&
                                <div className={style.country}>
                                    <img src={`https://www.matchtracker.live/v2/images/flags/${data.extra.away_manager.cc}.svg`} alt=""/>
                                </div>
                            }
                            <p>{data.extra.away_manager.name}</p>
                        </div>
                    }
                </div>
            </div>
